...
def format_output(result: Result) -> str:
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <pre>{{ result.correct_result.stdout.decode('utf-8') }}</pre>
            </td>
            <td>
                <pre>{{ result.stdout.stdout.decode('utf-8') }}</pre>
            </td>
        </tr>
        {% endif %}
        ...
        <tr>
            ...
            <td>
                <pre>{{ result.correct_result.stderr.decode('utf-8') }}</pre>
            </td>
            <td>
                <pre>{{ result.stderr.decode('utf-8') }}</pre>
            </td>
        </tr>
        {% endif %}
